//
//  PhotosTappedCollectionViewController.swift
//  photoTapted
//
...
class PhotosTappedCollectionViewController: UICollectionViewController {
...
//        collectionView.showsVerticalScrollIndicator = false
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "peakPhotoSegue" {
            let photoVC = segue.destination as! PhototViewController
...
extension PhotosTappedCollectionViewController: UICollectionViewDelegateFlowLayout {
